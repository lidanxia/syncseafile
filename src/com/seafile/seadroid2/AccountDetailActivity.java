...
/**
 * 确定登录成功后，就尝试与服务器连接，并保存账号，跳到共享目录页面
 * @author PC
 *
 */
 ...
 * 登录线程
 * @author PC
 * 登录后，用当前账号与服务器连接，并保存该账号证书，将账号保存到SharedPreferences中，并打开该账号的共享目录页面
 */
    private class LoginTask extends AsyncTask<Void, Void, String> {
         ...
         * 其次执行doInBackgroup方法  
         * 最优执行onPostExecute(final String result) ，result是doInBackgroup的返回值
         */ 
        @Override
...
/*
 * 用当前账户loginAccount与服务器连接，若成功返回Success,否则返回错误信息
 */

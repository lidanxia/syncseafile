...
/**
 * Update modified files, retry until success。是一个线程，定期更新上传任务，并上传
 *
 */
public class AutoUpdateManager implements Runnable, CachedFileChangedListener 
{
 ...
 /**
  * 将cachedFile添加到AutoUpdateInfo infos中,保存到AutoUpdateInfo表中并上传
  * @param account
  * @param cachedFile
  * @param localFile
  */  
 ...
 */
     ...
     * 
     * 将AutoUpdateInfo info从AutoUpdateInfo表中删除
     */
    ...
    /**
     * Periodically （定期）checks the upload tasks and schedule them to run
     **/

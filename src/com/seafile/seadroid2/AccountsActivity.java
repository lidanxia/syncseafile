...
/**
 * 账号的Activity,用户可以选择新账号登录，也可以用已有账号登录，并直接跳到共享目录页面，
 * 绑定服务FileMonitorService 
 * @author PC
 *
 */
public class AccountsActivity extends FragmentActivity
{
    ...
    public static final String default_email="840896291@qq.com";
    public static final String default_server="https://cloud.seafile.com";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        skipAccount.setOnClickListener(new View.OnClickListener() 
        {
            @Override
            public void onClick(View btn)
            {
    ...
    public void onStart() {
        ...
        bindService(bIntent, mMonitorConnection, Context.BIND_AUTO_CREATE);  //启动服务
        }
    }
